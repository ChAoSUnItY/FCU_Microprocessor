...
void UpdateAllLEDs(_Bool toggle)
{
...
void Buzz(_Bool toggle, uint32_t tone)
{
    if (!toggle)
        return;
...
void Show()
{
    ...
    case 2:
    {
        uint32_t tone = cycle < 25 ? 956 : 506;
