...
void Init_Key(void)
{
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) )), (0x00000008 | 0x00000010 | 0x00000020), 0x1UL);
    ...
    (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((3)<<2)))) = (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((4)<<2)))) = (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((5)<<2)))) = 0;
}
...
void evaluate(void)
{
    ...
    if (start && !done) {
        for (size_t i = 0; i < 4; i++) {
            ...
            x_poses[i] = ((x_poses[i] + ranks[i]) < (0) ? (0) : ((x_poses[i] + ranks[i]) > ((128 - 16)) ? ((128 - 16)) : (x_poses[i] + ranks[i])));
        }
