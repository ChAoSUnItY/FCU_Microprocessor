...
static int x = 64, y = 60, vx = 0, vy = 0, box_x, box_y;
static _Bool show_box;
...
void GenerateBox()
{
    ...
    box_x = rand() % (128 / 2 - 5 + 1 - 0) + 0;
    box_y = rand() % (64 / 2 - 5 + 1 - 0) + 0;
    show_box = 1;
}
...
_Bool CheckBoxCollision()
{
    return !(x + 4 <= box_x || box_x + 5 <= x - 4 || y + 4 <= box_y || box_y + 5 <= y - 4);
}
...
void Show()
{
    draw_Circle(x, y, 3, 0xFFFF, 0x0000);
    if (show_box)
        draw_Rectangle(box_x, box_y, box_x + 5, box_y + 5, 0x0000, 0xFFFF);
    CLK_SysTickDelay(100000);
    draw_Circle(x, y, 3, 0x0000, 0x0000);
    if (show_box)
        draw_Rectangle(box_x, box_y, box_x + 5, box_y + 5, 0x0000, 0x0000);
}
