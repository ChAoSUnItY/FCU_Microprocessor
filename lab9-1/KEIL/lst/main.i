...
volatile uint32_t *rgbs[3] = {&(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((14)<<2)))), &(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((13)<<2)))), &(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(0))) + ((12)<<2))))};
...
void Show()
{
    ...
    for (size_t x_offset = 0; x_offset < 16; x_offset++)
        draw_Line(x + x_offset, y, x + x_offset, y + 8, 0xFFFF, 0x0000);
    ...
    for (size_t x_offset = 0; x_offset < 16; x_offset++)
        draw_Line(x + x_offset, y, x + x_offset, y + 8, 0x0000, 0x0000);
}
...
int main(void)
{
    ...
    while (1)
    {
        ...
        while (u8ADF == 0);
        adc_val = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(7)] & (0xFFFFul << 0));
