...
void RTC_IRQHandler(void)
{
    ...
    new_sx = 64 - (20 - 2) * cos(theta_s * 3.1415926 / 180);
    new_sy = 32 - (20 - 2) * sin(theta_s * 3.1415926 / 180);

    draw_Line(old_sx, old_sy, 64, 32, 0x0000, 0x0000);
    draw_Line(new_sx, new_sy, 64, 32, 0xFFFF, 0x0000);

    old_sx = new_sx;
    old_sy = new_sy;
    
    new_mx = 64 - (13 - 2) * cos(theta_m * 3.1415926 / 180);
    new_my = 32 - (13 - 2) * sin(theta_m * 3.1415926 / 180);

    draw_Line(old_mx, old_my, 64, 32, 0x0000, 0x0000);
    draw_Line(new_mx, new_my, 64, 32, 0xFFFF, 0x0000);
...
int32_t main(void)
{
    ...
    old_mx = old_sx = 64 - (20 - 2) * cos(59 * 6 * 3.1415926 / 180);
    old_my = old_sy = 32 - (20 - 2) * sin(59 * 6 * 3.1415926 / 180);
