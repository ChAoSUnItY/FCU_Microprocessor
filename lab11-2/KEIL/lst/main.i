...
static uint32_t LITTLE_STAR_PITCH[48] = {
	500000, 500000, 500000, 500000, 500000, 500000, 500000, 1000000,
	500000, 500000, 500000, 500000, 500000, 500000, 500000, 1000000,
	500000, 500000, 500000, 500000, 500000, 500000, 500000, 1000000,
	500000, 500000, 500000, 500000, 500000, 500000, 500000, 1000000,
	500000, 500000, 500000, 500000, 500000, 500000, 500000, 1000000,
...
void ADC_IRQHandler(void)
{
    ...
    if (u32Flag & ((1ul << 0)))
    {
        u16_val = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(7)] & (0xFFFFul << 0));
...
int32_t main(void)
{
	...
	while (1) {
		...
		if (select == 2) {
			...
			PWM_ConfigOutputChannel(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), 0x0, music[select][i], volumn); 
			if (music[select][i] != 0)
				PWM_EnableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
			else
				PWM_DisableOutput(((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)), (1UL));
