...
static volatile _Bool stopped = 0;
static volatile _Bool redraw = 1;
...
{
    TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)), (1UL << 27), hz[speed_idx]);
    ((((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)))->TCSR = ((((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000)))->TCSR & ~(0xFFul << 0)) | (scale[speed_idx]));
...
void Show()
{
    ...
    clear_LCD();
    draw_Bmp64x64(128 / 2 - 32, 64 / 2 - 32, 0xFFFF, 0x0000, stopped ? RED : GREEN[state]);
    redraw = 0;
}
